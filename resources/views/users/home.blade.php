...
@section('content')
    <div class="row gx-5">
        <div class="col-8">
            ...
            @empty
                {{-- if the site doesnt have any post yet --}}
                <div class="text-center">
                    <h2>Share Photos</h2>
                    <p class="text-muted">When you share your photos, they'll appear on your profile.</p>
        ...
        <div class="col-4">
            ...
            <div class="row align-items-center mb-5 bg-white shadow-sm rounded-3 py-3">
                <div class="col-auto">
                    ...
                    @if (Auth::user()->avatar)
                        <img src="{{ Auth::user()->avatar }}" alt="{{ Auth::user()->avatar }}" class="rounded-circle avatar-md">
                    @else
