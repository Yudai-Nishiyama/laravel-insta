...
<head>
    ...
    {{-- asset() will access to public folder --}}
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                      {{-- {{ soon}} search bar here/ show it when a use logs in --}}
                      @auth
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                                ...
                                {{-- create post --}}
                                <li class="nav-item fropdown" title="Create Post">
                                    <a href="{{ route('post.create') }}" class="nav-link"><i class="fa-solid fa-circle-plus text-dark icon-sm"></i></a>
                                </li>

                                {{-- account --}}
                                <li class="nav-item dropdown">
                                    <button id="aacount-dropdown" class="btn shadow-none nav-link" data-bs-toggle="dropdown">
                                        @if (Auth::user()->avatar)
